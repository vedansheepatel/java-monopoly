...
public class Board {
    ...
    public Board() {
        ...
        locations[1] = new Property("Mediteranean Avenue", 575, 650, 60, 2, false, false);
        locations[2] = new communityChest("Community Chest", 520, 650);
        locations[3] = new Property("Baltic Avenue", 465, 650, 80, 4, false, false);
        locations[4] = new IncomeTax("IncomeTax", 410, 650);
        locations[5] = new Property("Reading Railroad", 355, 650, 200, 25, false, false);
        locations[6] = new Property("Oriental Avenue", 300, 650, 100, 6, false, false);
        locations[7] = new chance("Chance", 245, 650);
        locations[8] = new Property("Vermont Avenue", 180, 650, 100, 6, false, false);
        locations[9] = new Property("Connecticut Avenue", 105, 640, 120, 8, false, false);
